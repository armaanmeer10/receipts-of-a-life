...
export default function Ticker({ events, stats }) {
  ...
  const statsText = yearStats
    ? `YEAR ${selectedYear}: ${yearStats.plays != null ? `${num(yearStats.plays)} PLAYS` : 'NO PLAYS'} / ${yearStats.purchases != null ? `${num(yearStats.purchases)} PURCHASES` : 'NO LEDGER RECEIPTS'}`
